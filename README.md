...
## ChatCPT 평가
### 기대 효과
1. 복잡한 용어의 효과적인 설명: 프로그래밍, 게임, 수학과 관련된 어려운 용어를 명확하게 설명해 주어, 제자들이 더 잘 이해할 수 있도록 돕는다.
2. 동적인 게임 조건 및 이벤트 생성: 코드 작성 없이도 게임 내에서의 동적인 상황이나 이벤트를 생성할 수 있도록 도와준다.
3. 과제 분석 및 개선 제안: 제자들의 과제를 분석하고, 개선할 점이나 효과적인 대안에 대해 제안해준다.
### 강의의 단점
1. 과제 피드백의 어려움: 실습 위주의 수업 진행으로 인해 학생들의 과제를 효과적으로 분석하고 피드백을 제공하는 데 어려움을 겪고 있다.
2. 학생들의 동기 부여 부족: 학생들이 과제 수행 시에 동기를 잃는 경우가 많아, 이를 극복하기 위한 전략이 필요하다.
3. 과거 이력서 통과의 어려움: 취업 시장의 변화로 인해, 과거에는 통과되었던 이력서 내용이 현재는 통과되지 않는 경우가 많아 학생들의 서류 단계 통과에 대한 문제가 발생하고 있다.
